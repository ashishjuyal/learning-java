...
public class PhraseOMatic {
	...
	public static void main(String[] args) {
		...
		String[] wordListOne = {"24/7", "multi-Tiar","30,OOO foot","B-to-B","win-win",
				"front-end", "web-based","pervasive", "smart", 
				"six-sigma","cri tical-path", "dynamic"};
		
		String[] wordListTwo = {"empowered", "sticky",	"value-added", "oriented", 
				"centric", "distributed", "clustered", "branded","outaide-the-box", 
		...
		String[] wordListThree = {"process", "tipping-point", "solution", 
				...
				"portal", "apace", "vision",  "paradigm", "vision"};
